...
public class ColourPanel extends JFrame implements ActionListener, ChangeListener {
	...
	public static void cerrar() throws NativeHookException {
		...
		ColourPicker.frame.dispose();

		GlobalScreen.unregisterNativeHook();

	}

	public ColourPanel() throws AWTException {

		getContentPane().setBackground(Color.WHITE);

		setIconImage(Toolkit.getDefaultToolkit().getImage(ColourPanel.class.getResource("/imagenes/insert.png")));
		...
		setShape(new RoundRectangle2D.Double(0, 0, 100, 100, 100, 100));
